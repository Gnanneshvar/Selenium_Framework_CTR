...
public class Claims_Objectives extends CommonClass {
    ...
    public void fnFillingForm() throws InterruptedException {
        Reusble.selectByVisbileText(selectCC, "Warangal-Khammam-Nalgonda","Constiuency Council");
        Thread.sleep(2000);
        Reusble.selectByOption(selectDN, "30-Bhadradri","District Name");
        Thread.sleep(2000);
        Reusble.selectByValue(typeOfForm, "1","Type of Form");
        ...
        }catch(StaleElementReferenceException e)
        {
            ...
            Reusble.click(webelement,"View All");
        }
        Reusble.click(submit,"Submit ");
    }
